...
namespace SDN 
{
	...
	public:
		...
		void setAttenuation(float newValue) { attenuation = juce::jlimit(0.0f, 1.0f, newValue); };
		...
		void pushNextSample(juce::AudioBuffer<float>& sample) //TODO remove if not necessary
		{
